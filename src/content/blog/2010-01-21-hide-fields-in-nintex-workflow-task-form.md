...
{% figure "/files/images/2010/01/nintextaskformhidecolumn1.png", "Create a view, hiding the columns you don't want on the approval form", "510" %}

{% figure "/files/images/2010/01/nintextaskformhidecolumn2.png", "The field is not displayed to the approval form", "510" %}
