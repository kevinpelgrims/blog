...
tags: ["powershell"]
---
This is part two of four in a series of articles on the new features in PowerShell 2.0. Last time we discussed [background jobs]({{ "2010-04-27-powershell-2-0-background-jobs.md" | inputPathToUrl }}), now it's time for **transactions**!
